...
| --- | --- | ---: | ---: | ---: | ---: | ---: |
| YOLOv5s autoral | E01 | 0.7040 | 0.8210 | 0.8235 | 0.4560 | 0.7580 |
| YOLOv8s autoral | E02 | 0.9744 | 0.9605 | 0.9826 | 0.7652 | 0.9674 |
| YOLO11s autoral | E03 | 0.9720 | 0.9637 | 0.9819 | 0.7597 | 0.9679 |

## Tempo de validação

| Modelo | Exp | Total (s) | ms/img | device |
| --- | --- | ---: | ---: | --- |
| YOLOv5s autoral | E01 | 47.158 | 346.8 | 0 |
| YOLOv8s autoral | E02 | 16.399 | 120.6 | 0 |
| YOLO11s autoral | E03 | 16.258 | 119.5 | 0 |

## H1 — E02 vs E01 (YOLOv8 vs YOLOv5)

| Métrica | E02 | E01 | Δ (E02 − E01) |
| --- | ---: | ---: | ---: |
| Precision | 0.9744 | 0.7040 | +0.2704 |
| Recall | 0.9605 | 0.8210 | +0.1395 |
| mAP@0.50 | 0.9826 | 0.8235 | +0.1591 |
| mAP@0.50:0.95 | 0.7652 | 0.4560 | +0.3092 |
| F1 | 0.9674 | 0.7580 | +0.2094 |

## H2 — E03 vs E02 (YOLO11 vs YOLOv8)

| Métrica | E03 | E02 | Δ (E03 − E02) |
| --- | ---: | ---: | ---: |
| Precision | 0.9720 | 0.9744 | -0.0023 |
| Recall | 0.9637 | 0.9605 | +0.0032 |
| mAP@0.50 | 0.9819 | 0.9826 | -0.0007 |
| mAP@0.50:0.95 | 0.7597 | 0.7652 | -0.0055 |
| F1 | 0.9679 | 0.9674 | +0.0005 |
