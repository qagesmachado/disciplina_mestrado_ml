"""
Treino YOLO11 (E03) — venv_yolo_ultralytics.
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Treino Ultralytics (E03)")
    parser.add_argument("exp_id", default="E03", nargs="?")
    ...
    if exp.get("framework") != "ultralytics":
        raise SystemExit(f"{exp['id']} não pertence a YOLO_V11")
