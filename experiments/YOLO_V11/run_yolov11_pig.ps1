# Fluxo YOLO11 E03 — venv_yolo_ultralytics
...
Step "2/4 Treino E03" @("experiments/YOLO_V11/scripts/treinar.py", "E03")
Step "3/4 Validar E03" @("experiments/YOLO_V11/scripts/validar.py", "E03")
